<?php
/**
 * MGeohash generation class for php
 *
...
class Geohash {
    ...
    /**
     * Decode a MGeohash and return an array with decimal lat,long in it
     * Author: Bruce Chen (weibo: @一个开发者)
     */
    public function decode($hash) {
        ...
        //this to ensure I get the same roundings as MGeohash.org
    ...
    public function neighbors($srcHash) {
        $MGeohashPrefix = substr($srcHash, 0, strlen($srcHash) - 1);
    ...
    */
    ...
    /**
     * create binary encoding of number as detailed in http://en.wikipedia.org/wiki/MGeohash#Example
    ...
    /**
     * decodes binary encoding of number as detailed in http://en.wikipedia.org/wiki/MGeohash#Example
     * removing the tail recursion is left an exercise for the reader
     *
     * Author: Bruce Chen (weibo: @一个开发者)
     */
